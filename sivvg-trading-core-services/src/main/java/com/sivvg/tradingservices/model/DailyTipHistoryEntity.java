...
@Entity
@Table(name = "daily_tip_history")
public class DailyTipHistoryEntity {
	...
	@NotBlank(message = "Plan type is required") // BASIC / STANDARD / PREMIUM / VIP
	...
	public DailyTipHistoryEntity(Long id, @NotBlank(message = "Stock code is required") String stockCode,
			Double stockPrice, @NotBlank(message = "Stock type is required") String stockType,
			...
			Boolean t1Reached, Boolean t2Reached, Boolean t3Reached, LocalDateTime t1ReachedTime,
	...
	public String toString() {
		return "DailyTipHistoryEntity [id=" + id + ", stockCode=" + stockCode + ", stockPrice=" + stockPrice
				+ ", stockType=" + stockType + ", category=" + category + ", planType=" + planType + ", sectorType="
				+ sectorType + ", t1=" + t1 + ", t2=" + t2 + ", t3=" + t3 + ", t1Reached=" + t1Reached + ", t2Reached="
				+ t2Reached + ", t3Reached=" + t3Reached + ", t1ReachedTime=" + t1ReachedTime + ", t2ReachedTime="
				+ t2ReachedTime + ", t3ReachedTime=" + t3ReachedTime + ", optionType=" + optionType + ", strikePrice="
				+ strikePrice + ", atm=" + atm + ", otm=" + otm + ", targetPrice=" + targetPrice + ", targetReached="
				+ targetReached + ", currentPrice=" + currentPrice + ", priceDifference=" + priceDifference
				+ ", createdAt=" + createdAt + ", postedTime=" + postedTime + ", updatedAt=" + updatedAt + "]";
	}
