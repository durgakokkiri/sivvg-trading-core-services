...
import com.sivvg.tradingservices.serviceImpl.ContactUSServiceImpl;
...
public class AdminUserControllerTest {
    ...
    public void updateUser_success() throws Exception {
        ...
        when(adminService.updateUser(eq(1L), any(RegisterRequest.class)))
                .thenReturn(req);
    ...
    public void getUserCounts_success() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/admin/user-counts"))
                .andExpect(status().isOk())
    ...
    public void uploadHolidays_success() throws Exception {
        ...
        when(repo.save(any(MarketHolidayEntity.class)))
                .thenReturn(new MarketHolidayEntity());
    ...
    void testGetAllContacts() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/admin/contacts"))
                ...
                .andExpect(jsonPath("$[0].message").value("Need help"));
    }
    ...
    void testGetContactById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/admin/contacts/1"))
                .andExpect(status().isOk())
    ...
    void testReplyToContact() throws Exception {
        ...
        doNothing().when(contactService)
                .replyToContact(eq(1L), any(AdminReplyDTO.class));

        mockMvc.perform(put("/api/v1/admin/contacts/1/reply")
                .with(csrf())
                .contentType(MediaType.APPLICATION_JSON)
